...
public class RegisterStaffController implements Initializable {
    ...
    void AddStaff(ActionEvent event) {
        ...
        try {
            ...
            if(v.validateEmpty(empNoField)&& v.validateEmpty(teacherNameField)
                    && v.validateEmpty(taughtSubjectField)&& v.validateEmpty(dobField)
                ...
                if (i > 0) {
                    ...
                    alert.setTitle("Staff Registration");
                    alert.setHeaderText(null);
                    alert.setContentText("There was an error when trying to register staff.");
                    alert.showAndWait();
                }
            }
